package com.crystallake.clippicture.crop;
...
import com.crystallake.clippicture.R;
...
public class Crop {
    ...
    public Crop addFlags(int flags){
    ...
    private static void showImagePickerError(Context context) {
        Toast.makeText(context.getApplicationContext(), R.string.crop_pick_error, Toast.LENGTH_SHORT).show();
    }
